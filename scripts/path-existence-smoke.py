...
ALLOW_PATTERNS: tuple[re.Pattern[str], ...] = (
    ...
    # quoted in services/agent/README.md as a strikethrough row to
    # document what was removed.  Same pattern as the dropped-A2
    # modules above.  Bare `crypto/ots.py` shape matches the README's
    # backtick-quoted reference.
    re.compile(r"^crypto/ots\.py$"),
